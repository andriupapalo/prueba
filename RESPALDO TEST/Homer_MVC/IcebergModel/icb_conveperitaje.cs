...
namespace Homer_MVC.IcebergModel
{
    ...
    public partial class icb_conveperitaje
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public icb_conveperitaje()
        {
            this.icb_insp_peritaje = new HashSet<icb_insp_peritaje>();
        }
    
        public int conve_id { get; set; }
        public string conve_nombre { get; set; }
        public string conve_des { get; set; }
