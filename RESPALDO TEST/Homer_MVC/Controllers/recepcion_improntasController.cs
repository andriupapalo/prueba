...
{
    public class recepcion_improntasController : Controller
    {
        private readonly Iceberg_Context context = new Iceberg_Context();

        private void parametrosBusqueda()
        {
            IQueryable<icb_modulo_enlaces> enlacesBuscar = context.icb_modulo_enlaces.Where(x => x.enl_modulo == 127);
            string enlaces = "";
        ...
        public ActionResult recepcion_improntas(int? menu)
        {
            parametrosBusqueda();
        ...
        [HttpPost]
        public ActionResult recepcion_improntas(IngresoVhModel modelo, int? menu)
        {
            ...
            foreach (string item in exploded)
            {
                if (item != "")
                {
                    ...
                    if (buscaVin != null)
                    {
                        buscaVin.icbvh_fec_recepcionimpronta = DateTime.Now;
                    ...
                    if (result)
                    {
                        TempData["mensaje"] = "La recepcion de la impronta fue exitoso!";

                        icb_sysparameter buscarParametroTpEvento =
                            context.icb_sysparameter.FirstOrDefault(x => x.syspar_cod == "P14");
                        string tpEventoParametro =
                            buscarParametroTpEvento != null ? buscarParametroTpEvento.syspar_value : "9";
                        ...
                        context.icb_vehiculo_eventos.Add(new icb_vehiculo_eventos
                        {
                            ...
                            evento_nombre = "Recepcion Impronta",
                            evento_estado = true,
                            evento_observacion = "Se realiza recepcion de impronta",
                            //id_vehiculo = id,
                            vin = buscaVin.vin,
        ...
        public JsonResult BuscarImprontasPaginados()
        {
            ...
            var query = (from vehiculo in context.icb_vehiculo
                         ...
                         where vehiculo.icbvh_estatus == "6"
                               ...
                               && vehiculo.icbvh_fec_recepcionimpronta == null
