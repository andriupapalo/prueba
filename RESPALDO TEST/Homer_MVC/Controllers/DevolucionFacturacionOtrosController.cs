...
{
    public class DevolucionFacturacionOtrosController : Controller
    {
        ...
        {
            ViewBag.doc_registros = context.tp_doc_registros.Where(x => x.tipo == 38);
            ...
            var infoVenta = (from e in context.encab_documento
                             ...
                             select new
                             {
                                 fletes = e.fletes != null ? e.fletes : 0,
                                 iva_fletes = e.iva_fletes != null ? e.iva_fletes : 0,
                                 e.moneda,
                                 m.descripcion,
                                 e.tasa,
        ...
        // GET: DevolucionFacturacionOtros
        ...
        public JsonResult DevolucionAutomatica(int bodega, int nit, int tipo_doc, int id_devolucion)
        {
            #region variables
                        ...
                        try
                        {
                            ...
                            foreach (mov_contable movimientos in movimientosContables)
                            {
                                ...
                                if (buscarCuenta != null)
                                {
                                    ...
                                    #region Inventario /// COMENTADO PARA QUE NO AFECTE 
                            ...
                            foreach (lineas_documento item in lineasReferencias)
                            {
                                ...
                                #region referencias inven ///COMENTADO  PAR  QUE NO AFECTE

                                //var referencia = context.referencias_inven.FirstOrDefault(x => x.codigo == item.codigo && x.ano == DateTime.Now.Year && x.mes == DateTime.Now.Month && x.bodega == bodega);
                                //if (referencia != null)
                                //{
                                ...
                                //    refe.codigo = item.codigo;
                                //    refe.bodega = bodega;
                                //    refe.ano = Convert.ToInt16(DateTime.Now.Year);
                                //    refe.mes = Convert.ToInt16(DateTime.Now.Month);
                                //    refe.can_sal = item.cantidad;
                                //    refe.cos_sal = item.valor_unitario * item.cantidad;
                                //    refe.can_dev_com = item.cantidad;
                                //    refe.cos_dev_com = item.valor_unitario * item.cantidad;
                                //    refe.modulo = "R";
                            ...
                            if (grupo != null)
                            {
                                ...
                                for (int i = 0; i <= listaLineas; i++)
                                    if (!string.IsNullOrEmpty(Request["codigo" + i]))
                                    {
                                        ...
                                        //Referencias Inven // Existe validacion para NO MODIFICAR INVENTARIO

                                        #region referencias inven

                                        string codigoRef = Request["codigo" + i]; // ojo fue copiado
                                        ...
                                        if (opcionSi)
                                        {
                                            ...
                                            if (existencia != null)
                                            {
                                                ...
                                                existencia.cos_ent +=
                                                    final * Convert.ToDecimal(Request["cantidadDevolver" + i], miCultura);
                                            ...
                                            else
                                            {
                                                ...
                                                refin.can_sal = Convert.ToDecimal(Request["cantidadDevolver" + i], miCultura);
                                                refin.cos_sal = final;
                                                refin.can_dev_vta = Convert.ToDecimal(Request["cantidadDevolver" + i], miCultura);
                                                refin.cos_dev_vta = costoReferenciaFinal;
                                                refin.val_dev =
                                                    Convert.ToDecimal(Request["cantidadDevolver" + i], miCultura) *
                                                    Convert.ToDecimal(Request["valor_unitario" + i], miCultura);
                                                refin.modulo = "R";
                                        ...
                                        foreach (var parametro in parametrosCuentasVerificar)
                                        {
                                            ...
                                            if (buscarCuenta != null)
                                            {
                                                if (parametro.id_nombre_parametro == 2 &&
                                                    ...
                                                    Convert.ToDecimal(valor_totalenca) != 0
        ...
        public ActionResult DevolucionVenta(encab_documento encabezado, int? menu)
        {
            ...
            if (totalDebitos != totalCreditos)
            {
                ...
                context.SaveChanges();
                return RedirectToAction("Index", "DevolucionFacturacionOtros", new { menu });
            }
        ...
        public ActionResult DetalleDevoluciones(int id, int? menu)
        {
            ...
            ViewBag.fletes = (from a in context.encab_documento
                              where a.idencabezado == id
                              select a.fletes != null ? a.fletes : 0).FirstOrDefault();

            ViewBag.ivafletes = (from a in context.encab_documento
                                 where a.idencabezado == id
                                 select a.iva_fletes != null ? a.iva_fletes : 0).FirstOrDefault();
        ...
        //public JsonResult DevolucionAutomaticaXXXXX(int bodega, int nit, int tipo_doc, int id_devolucion)
        //{
        //    #region variables
        ...
        //        var castString = devolucion.numero.ToString();
        //        var buscarDevolucion = context.encab_documento.Where(x => x.prefijo == devolucion.idencabezado && x.bodega == bodegaActual && x.documento == castString).FirstOrDefault();
        //        if (buscarDevolucion != null)
        //        {
        //            var mensaje = "La factura ya fue devuelta, el numero de devolucion es <span class='label label-default'>" + buscarDevolucion.numero + "</span>";
        //            return Json(new { devuelto = true, mensaje }, JsonRequestBehavior.AllowGet);
        //        }
        //        // Fin validacion para saber si el documento ya se le realizo una devolucion

        //        var perfilContable = devolucion.perfilcontable;
        ...
        //        #region validar referencias compradas
        //        var referenciasLineasCompradas = context.lineas_documento.Where(x => x.id_encabezado == id_devolucion).Select(x => x.codigo).ToList();

        //        var fechaActual = DateTime.Now;

        //        var lineasReferencias = context.lineas_documento.Where(x => x.id_encabezado == id_devolucion).ToList();
        //        var movimientosContables = context.mov_contable.Where(x => x.id_encab == id_devolucion).ToList();
        //        #endregion
        //        //consecutivo
        //        var grupo = context.grupoconsecutivos.FirstOrDefault(x => x.documento_id == tipo_doc && x.bodega_id == bodega);
        //        if (grupo != null)
        //        {
        //            DocumentoPorBodegaController doc = new DocumentoPorBodegaController();
        ...
        //                    encabezado.nit = nit;
        //                    encabezado.fecha = DateTime.Now;
        //                    var condicion = devolucion.fpago_id;
        //                    encabezado.fpago_id = condicion;
        ...
        //                    #region cruce documentos
        //                    cruce_documentos cruce = new cruce_documentos();
        //                    cruce.idtipo = tipo_doc;
        //                    cruce.numero = consecutivo;
        //                    cruce.idtipoaplica = devolucion.tipo;
        //                    cruce.numeroaplica = devolucion.numero;
        //                    cruce.valor = devolucion.valor_total;
        //                    cruce.fecha = fechaActual;
        //                    cruce.fechacruce = fechaActual;
        //                    cruce.userid_creacion = Convert.ToInt32(Session["user_usuarioid"]);
        ...
        //                    foreach (var movimientos in movimientosContables)
        //                    {
        //                        var descripcionParametro = context.paramcontablenombres.FirstOrDefault(x => x.id == movimientos.idparametronombre).descripcion_parametro;
        //                        var buscarCuenta = context.cuenta_puc.FirstOrDefault(x => x.cntpuc_id == movimientos.cuenta);
        ...
        //                            movNuevo.id_encab = encabezado.idencabezado;
        //                            movNuevo.seq = secuencia;
        //                            movNuevo.idparametronombre = movimientos.idparametronombre;
        //                            movNuevo.cuenta = movimientos.cuenta;
        //                            movNuevo.centro = movimientos.centro;
        //                            movNuevo.fec = DateTime.Now;
        //                            movNuevo.fec_creacion = DateTime.Now;
        //                            movNuevo.userid_creacion = Convert.ToInt32(Session["user_usuarioid"]);
        //                            movNuevo.documento = devolucion.documento;

        //                            var info = context.cuenta_puc.Where(a => a.cntpuc_id == movimientos.cuenta).FirstOrDefault();
        ...
        //                            //Cuentas valores
        //                            #region Cuentas valores
        //                            var buscar_cuentas_valores = context.cuentas_valores.FirstOrDefault(x => x.centro == movimientos.centro && x.cuenta == movimientos.cuenta && x.nit == movNuevo.nit && x.ano == fechaActual.Year && x.mes == fechaActual.Month);
        //                            if (buscar_cuentas_valores != null)
        //                            {
        //                                buscar_cuentas_valores.debito += movNuevo.debito;
        //                                buscar_cuentas_valores.credito += movNuevo.credito;
        ...
        //                                crearCuentaValor.ano = fechaActual.Year;
        //                                crearCuentaValor.mes = fechaActual.Month;
        ...
        //                    var i = 0;
        //                    foreach (var item in lineasReferencias)
        //                    {
        //                        if (item.codigo != null)
        //                        {
        //                            i++;
        ...
        //                            linea.costo_unitario = item.valor_unitario;
        //                            linea.bodega = bodega;
        //                            linea.cantidad_pedida = item.cantidad;
        //                            linea.fec_creacion = DateTime.Now;
        //                            linea.estado = true;
        //                            linea.moneda = devolucion.moneda;
        //                            linea.tasa = devolucion.tasa;
        //                            linea.pedido = Convert.ToInt32(item.pedido);
        //                            var por_iva = context.icb_referencia.Find(item.codigo);
        //                            if (por_iva != null)
        //                            {
        //                                linea.porcentaje_iva = por_iva.por_iva_compra;
        //                            }
        ...
        //                            //actualizamos las lineas de la compra, ponemos la cantidad devuelta (todas)
        //                            var lineaDevuelta = context.lineas_documento.FirstOrDefault(x => x.id_encabezado == id_devolucion && x.codigo == item.codigo);
        ...
        //                        ViewBag.calculoCredito = totalCreditos;
        //                        dbTran.Rollback();
        //                        return Json(new { descuadrado = true, deb = totalDebitos, cred = totalCreditos, lista = listaDescuadrados }, JsonRequestBehavior.AllowGet);
        //                    }
        //                    else
        //                    {
        //                        context.SaveChanges();
        ...
        //                        DocumentoPorBodegaController conse = new DocumentoPorBodegaController();
        //                        doc.ActualizarConsecutivo(grupo.grupo, consecutivo);
        //                        return Json(new { exito = true, numeroConsecutivo = encabezado.numero }, JsonRequestBehavior.AllowGet);
        //                    }
        //                    #endregion
        //                }
        ...
        //        else
        //        {
        //            var mensaje = "No se encontro el grupo para este documento.";
        //            return Json(new { mensaje, valorGuardado = false }, JsonRequestBehavior.AllowGet);
        //        }
        //    }
        //    else
            ...
            decimal totalIVA)
        {
            ...
            if (buscarPerfilTributario != null)
            {
                ...
                {
                    reteiva = Math.Round(totalIVA * Convert.ToDecimal(buscarTipoDocRegistro.retiva / 100, miCultura));
                }

                if (buscarPerfilTributario.autorretencion == "A") //autoretencion
                {
                    decimal tercero_acteco = buscarProveedor.acteco_tercero.autorretencion;
                    autoRetencion = Math.Round((subTotal - totalDes) * Convert.ToDecimal(tercero_acteco / 100, miCultura));
                }
        ...
        public JsonResult buscarFacturaDevolver(int idDevol)
        {
            ...
            var data = from e in context.encab_documento
                       ...
                       join tp in context.tp_doc_registros
                           on e.tipo equals tp.tpdoc_id
                       where tp.tipo == 37 && e.idencabezado == idDevol
                       select new
                       {
                           tipoDocumento = "(" + tp.prefijo + ") " + tp.tpdoc_nombre,
                           e.numero,
