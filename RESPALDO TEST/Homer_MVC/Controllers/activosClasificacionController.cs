...
{
    public class activosClasificacionController : Controller
    {
        ...
        public void ConsultaDatosCreacion(activoclasificacion clasif)
        {
            if (clasif != null)
            {
                //consulta el nombre de usuario creacion con el id, lo envia a la vista a traves de ViewBag
        ...
        {
            var data = (from clasif in context.activoclasificacion
